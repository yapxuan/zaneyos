...
in
{
  wayland.windowManager.hyprland.settings = {
    bind = [
      ...
      "$modifier ALT, left, resizeactive,-20 0"
      "$modifier ALT, right, resizeactive,20 0"
      "$modifier ALT, up, resizeactive,0 -20"
      "$modifier ALT, down, resizeactive,0 20"
